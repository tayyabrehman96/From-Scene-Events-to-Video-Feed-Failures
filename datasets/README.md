...
| [`dataset_distribution.csv`](dataset_distribution.csv) | Counts and shares by tier, public access, composition, and annotation family; summed VAD train/test volume where numeric |
